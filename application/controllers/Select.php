...
class Select extends CI_Controller
{
	...
	public function select_job()
	{
		...
		$jobtek = $this->db->query("SELECT A.progress, A.status, A.id_ticket, A.tanggal, 
		...
		//print_r($data['dataassigment']);
		$object = array();
            foreach ($jobtek as $value) {
            ...
            $data['dataassigment'] = (object) $object;
