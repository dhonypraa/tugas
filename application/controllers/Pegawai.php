...
class Pegawai extends CI_Controller
{
	public function __construct()
	{
		...
		//load librariy vigenere chipers
	...
	public function index()
	{
		...
		if($this->session->userdata('level') == "Admin"){
			...
			$object = array();
	        foreach ($this->model_app->pegawai()->result() as $value) {
			  array_push($object, (object) array(
			  	'nik' => $value->nik,
			  	'nama' => decryptAES_vigenere($value->nama),
			  	'email' => decryptAES_vigenere($value->email),
			  	'nama_jabatan' => $value->nama_jabatan,
			  	'nama_bagian_dept' => $value->nama_bagian_dept,
			  	'nama_dept' => $value->nama_dept,
			  ));
			}
			$data['pegawai'] = (object) $object;
	...
	public function tambah()
	{
		...
		$this->form_validation->set_rules('nik', 'Nik', 'required|is_unique[karyawan.nik]',
			array(
				'required' => '<div class="alert alert-danger alert-dismissable">
									<strong>Gagal!</strong> Masukan No NIK.
							   </div>',
				'is_unique' => '<div class="alert alert-danger alert-dismissable">
									<strong>Gagal!</strong> NIK Ini Sudah Ada.
							   </div>'
			)
		);
		...
		$this->form_validation->set_rules('nama', 'Nama', 'required',
			array(
				'required' => '<div class="alert alert-danger alert-dismissable">
									<strong>Gagal!</strong> Silahkan Masukkan Nama.
							   </div>'
			)
		);
		...
		$this->form_validation->set_rules('email', 'Email', 'required',
			array(
				'required' => '<div class="alert alert-danger alert-dismissable">
									<strong>Gagal!</strong> Silahkan Masukkan Email.
							   </div>'
			)
		);
		...
		$this->form_validation->set_rules('id_jabatan', 'Id_jabatan', 'required',
			array(
				'required' => '<div class="alert alert-danger alert-dismissable">
									<strong>Gagal!</strong> Silahkan Pilih Jabatan.
							   </div>'
			)
		);
		...
		$this->form_validation->set_rules('id_departemen', 'Id_departemen', 'required',
			array(
				'required' => '<div class="alert alert-danger alert-dismissable">
									<strong>Gagal!</strong> Silahkan Pilih Departmen.
							   </div>'
			)
		);
		...
		$this->form_validation->set_rules('id_bagian_departemen', 'Id_bagian_departemen', 'required',
			array(
				'required' => '<div class="alert alert-danger alert-dismissable">
									<strong>Gagal!</strong> Silahkan Pilih Sub Departmen.
							   </div>'
			)
		);
		...
		if($this->form_validation->run() == FALSE){
			...
			$data = array(
				...
				'notelp'		 => encryptAES_vigenere(trim($this->input->post('notelp'))),
