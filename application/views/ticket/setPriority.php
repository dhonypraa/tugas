...
<div class="container-fluid">
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Tetapkan Prioritas dan Teknisi (<?php echo $detail['id_ticket']?>)</h1>
	</div><hr>
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<div class="form-group">
					<label class="m-0 font-weight-bold text-primary">Prioritas</label>
				...
				<h6 class="m-0 font-weight-bold text-primary">Pilih Teknisi</h6>
				<div class="form-group">
				...
				<button type="button" class="btn btn-danger" onclick="window.location='<?php echo site_url('List_ticket/list_approve') ?>'">Batal</button><p>
			</div>
		</div>
	</form>
</div>