...
<div class="container-fluid">
	<h1 class="h3 mb-0 text-gray-800">Buat Tiket Anda</h1>
	<p class="mb-4">Silakan simpulkan masalah Anda.</p>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Buat Tiket Anda</h6>
		</div>
		<div class="card-body">
			<form method="post" action="<?php echo site_url('List_ticket_user/submit')?>" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label class="m-0 font-weight-bold text-primary">Subyek</label>
					<input class="form-control" name="problem_summary" placeholder="Subject">
				</div>

				<div class="form-group">
					<label class="m-0 font-weight-bold text-primary">Deskripsi</label>
					<textarea name="problem_detail" placeholder="Describe your problem" class="form-control" rows="10"></textarea>
				</div>

				<div class="form-group">
					<label class="m-0 font-weight-bold text-primary">Lampiran</label> </br>
