<div class="container-fluid">
	<h1 class="h3 mb-0 text-gray-800">Sub Departmen</h1><hr>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			...
			<a href="#modal-fade" title="Add Sub Department" class="btn btn-primary" data-toggle="modal">
				<i class="fa fa-plus"></i> Tambah Sub Departmen
			</a>
		</div>
...
<div id="modal-fade" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<h6 class="m-0 font-weight-bold text-gray-800">Tambah Sub Departmen</h6>
		</div>
			<div class="modal-body">
				...
				<form id="form-validation" action="<?php echo site_url('Subdept/tambah') ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>Nama of Sub Department</label>
