	...
	<form method="post" action="<?php echo site_url('List_ticket_tek/update/'.$detail['id_ticket']) ?>" enctype="multipart/form-data">
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<h6 class="m-0 font-weight-bold text-primary">Progress</h6><br>
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<div class="form-group">
					<h6 class="m-0 font-weight-bold text-primary">Deskripsi</h6><br>
				...
				<div class="form-group">
					...
					<code>*Jelaskan kemajuan Anda terlebih dahulu sebelum memilih kemajuan</code>
				</div><hr>
