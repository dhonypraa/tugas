...
<div class="container-fluid">
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Ubah Kategori (<?php echo $detail['id_ticket']?>)</h1>
	</div>
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<div class="form-group">
					<h6 class="m-0 font-weight-bold text-primary">Jelaskan Diagnosis Anda</h6><br>
				...
				<div class="form-group">
					...
					<code>*Jelaskan diagnosis Anda terlebih dahulu sebelum memilih kategori</code>
				</div><hr>
				...
				<div class="form-group">
					...
					<code>*Jelaskan diagnosis Anda terlebih dahulu sebelum memilih sub kategori</code>
				</div><hr>
				<div class="form-group">
