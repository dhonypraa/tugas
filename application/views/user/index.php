<div class="container-fluid">
	<h1 class="h3 mb-0 text-gray-800">Akun pengguna</h1><hr>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-gray-800">Data Akun Pengguna</h6><hr>
			<a href="#modal-fade" title="Add User" class="btn btn-primary" data-toggle="modal">
				<i class="fa fa-plus"></i> Tambah Akun Pengguna
			</a>
		</div>
