...
<div class="container-fluid">
	<h1 class="h3 mb-0 text-gray-800">Karyawan</h1><hr>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-gray-800">Data Karyawan</h6><hr>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="m-0 font-weight-bold text-gray-800">Tambah Karyawan</h6>
			</div>
			<div class="modal-body">
				...
				<form id="form-validation" action="<?php echo site_url('Pegawai/tambah') ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>Notelp</label>
						<input class="form-control" name="notelp" placeholder="Input here..." rows="3">
					</div>			
					<div class="form-group">
						<label>Posisi</label>
